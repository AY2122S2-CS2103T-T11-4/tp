...
public class EditPersonDescriptorTest {
    ...
    public void equals() {
        ...
        EditCommand.EditPersonDescriptor editedAmy = new EditPersonDescriptorBuilder(
        ...
        editedAmy = new EditPersonDescriptorBuilder(
        ...
        editedAmy = new EditPersonDescriptorBuilder(
                CommandTestUtil.DESC_AMY).withTags(CommandTestUtil.VALID_TAG_HUSBAND).build();
        Assertions.assertFalse(CommandTestUtil.DESC_AMY.equals(editedAmy));
    }
}
